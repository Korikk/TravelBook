...
class DetailsVC: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
                            ...
                            if let subtitle = result.value(forKey: "subtitle") as? String {
                                ...
                                if let latitude = result.value(forKey: "latitude") as? Double {
                                    ...
                                    if let longitude = result.value(forKey: "longitude") as? Double {
                                        ...
                                        let coordinate = CLLocationCoordinate2D(latitude: annatotionLatitude, longitude: annotationLongitude)
    ...
    func mapView(_ mapView: MKMapView, annotationView view: MKAnnotationView, calloutAccessoryControlTapped control: UIControl) {
        if selectedTitle != ""{
            ...
            let requesLocation = CLLocation(latitude: annatotionLatitude, longitude: annotationLongitude)
    ...
    @IBAction func saveClicked(_ sender: Any) {
        ...
        newPlaces.setValue(descriptionText.text, forKey: "subtitle")
